      ...
      000062                        318 _main:
                           ...
                           000000   326 	ar0 = 0x00
                                    327 ;	lab9.c:5: x=1;
      000062 75 09 01         [24]  328 	mov	_x,#0x01
                                    329 ;	lab9.c:9: P1=~x;
      000065 75 90 FE         [24]  330 	mov	_P1,#0xfe
                                    331 ;	lab9.c:10: while(1) {
      000068                        332 00105$:
                                    333 ;	lab9.c:11: for(i=0;i<5;i++);
      000068 75 08 05         [24]  334 	mov	_i,#0x05
      00006B                        335 00109$:
      00006B D5 08 FD         [24]  336 	djnz	_i,00109$
      00006E 75 08 05         [24]  337 	mov	_i,#0x05
                                    338 ;	lab9.c:12: P1=~x;
      000071 E5 09            [12]  339 	mov	a,_x
      000073 F4               [12]  340 	cpl	a
      000074 F5 90            [12]  341 	mov	_P1,a
                                    342 ;	lab9.c:13: x=x<<1;
      000076 E5 09            [12]  343 	mov	a,_x
      000078 25 E0            [12]  344 	add	a,acc
      00007A F5 09            [12]  345 	mov	_x,a
                                    346 ;	lab9.c:14: if(P1_7==0) {
      00007C 20 97 E9         [24]  347 	jb	_P1_7,00105$
                                    348 ;	lab9.c:15: x=1;
      00007F 75 09 01         [24]  349 	mov	_x,#0x01
                                    350 ;	lab9.c:19: return 0;
                                    351 ;	lab9.c:20: }
      000082 80 E4            [24]  352 	sjmp	00105$
                                    353 	.area CSEG    (CODE)
                                    354 	.area CONST   (CODE)
                                    355 	.area XINIT   (CODE)
