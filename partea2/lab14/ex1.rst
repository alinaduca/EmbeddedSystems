      ...
      000062 75 08 C0         [24]  334 	mov	_v,#0xc0
                                    335 ;	ex1.c:6: v[1] = 0xF9;
      000065 75 09 F9         [24]  336 	mov	(_v + 0x0001),#0xf9
                                    337 ;	ex1.c:7: v[2] = 0xA4;
      000068 75 0A A4         [24]  338 	mov	(_v + 0x0002),#0xa4
                                    339 ;	ex1.c:8: v[3] = 0xB0;
      00006B 75 0B B0         [24]  340 	mov	(_v + 0x0003),#0xb0
                                    341 ;	ex1.c:9: v[4] = 0x99;
      00006E 75 0C 99         [24]  342 	mov	(_v + 0x0004),#0x99
                                    343 ;	ex1.c:10: v[5] = 0x92;
      000071 75 0D 92         [24]  344 	mov	(_v + 0x0005),#0x92
                                    345 ;	ex1.c:11: v[6] = 0x82;
      000074 75 0E 82         [24]  346 	mov	(_v + 0x0006),#0x82
                                    347 ;	ex1.c:12: v[7] = 0xF8;
      000077 75 0F F8         [24]  348 	mov	(_v + 0x0007),#0xf8
                                    349 ;	ex1.c:13: v[8] = 0x80;
      00007A 75 10 80         [24]  350 	mov	(_v + 0x0008),#0x80
                                    351 ;	ex1.c:14: v[9] = 0x90;
      00007D 75 11 90         [24]  352 	mov	(_v + 0x0009),#0x90
                                    353 ;	ex1.c:15: while(1) {
      000080                        354 00106$:
                                    355 ;	ex1.c:16: P3 = 0xFF;
      000080 75 B0 FF         [24]  356 	mov	_P3,#0xff
                                    357 ;	ex1.c:17: P3_6 = 0;
                                    358 ;	assignBit
      000083 C2 B6            [12]  359 	clr	_P3_6
                                    360 ;	ex1.c:18: P3_6 = 1; //front crescator pt activarea WR
                                    361 ;	assignBit
      000085 D2 B6            [12]  362 	setb	_P3_6
                                    363 ;	ex1.c:19: while(P3_2 == 1) ; //pt INTR
      000087                        364 00101$:
      000087 20 B2 FD         [24]  365 	jb	_P3_2,00101$
                                    366 ;	ex1.c:20: P3_7 = 0; //ma pregatesc de citire
                                    367 ;	assignBit
      00008A C2 B7            [12]  368 	clr	_P3_7
                                    369 ;	ex1.c:21: x = P2;
      00008C 85 A0 14         [24]  370 	mov	_x,_P2
                                    371 ;	ex1.c:22: P3_7 = 1;
                                    372 ;	assignBit
      00008F D2 B7            [12]  373 	setb	_P3_7
                                    374 ;	ex1.c:23: c = x / 51;
      000091 AE 14            [24]  375 	mov	r6,_x
      000093 7F 00            [12]  376 	mov	r7,#0x00
      000095 75 15 33         [24]  377 	mov	__divsint_PARM_2,#0x33
                                    378 ;	1-genFromRTrack replaced	mov	(__divsint_PARM_2 + 1),#0x00
      000098 8F 16            [24]  379 	mov	(__divsint_PARM_2 + 1),r7
      00009A 8E 82            [24]  380 	mov	dpl,r6
      00009C 8F 83            [24]  381 	mov	dph,r7
      00009E 12 00 E8         [24]  382 	lcall	__divsint
      0000A1 AE 82            [24]  383 	mov	r6,dpl
      0000A3 AF 83            [24]  384 	mov	r7,dph
      0000A5 8E 13            [24]  385 	mov	_c,r6
                                    386 ;	ex1.c:24: P3 = 0x00;
      0000A7 75 B0 00         [24]  387 	mov	_P3,#0x00
                                    388 ;	ex1.c:25: P1 = v[c];
      0000AA E5 13            [12]  389 	mov	a,_c
      0000AC 24 08            [12]  390 	add	a,#_v
      0000AE F9               [12]  391 	mov	r1,a
      0000AF 87 90            [24]  392 	mov	_P1,@r1
                                    393 ;	ex1.c:26: for(i=0; i<100; i++) ;
      0000B1 75 12 64         [24]  394 	mov	_i,#0x64
      0000B4                        395 00110$:
      0000B4 D5 12 FD         [24]  396 	djnz	_i,00110$
      0000B7 75 12 64         [24]  397 	mov	_i,#0x64
                                    398 ;	ex1.c:27: P1 = 0xFF;
      0000BA 75 90 FF         [24]  399 	mov	_P1,#0xff
                                    400 ;	ex1.c:29: return 0;
                                    401 ;	ex1.c:30: }
      0000BD 80 C1            [24]  402 	sjmp	00106$
                                    403 	.area CSEG    (CODE)
                                    404 	.area CONST   (CODE)
                                    405 	.area XINIT   (CODE)
